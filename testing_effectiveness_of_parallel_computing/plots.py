...
def vcluster_time_processes():
    df_poor_mean = pd.read_csv("vcluster_mean_scaling_poor.csv", delimiter=";", header=None,
                               names=['proc', 'size', 'time', 'pi', 'speedup', 'efficiency', 'serial_fraction'])
    df_strong_mean = pd.read_csv("vcluster_mean_scaling_strong.csv", delimiter=";", header=None,
                                 names=['proc', 'size', 'time', 'pi', 'speedup', 'efficiency', 'serial_fraction'])
    df_poor = pd.read_csv("vcluster_scaling_strong.csv", delimiter=";", header=None,
                          names=['proc', 'size', 'time', 'pi'])

    df_strong = pd.read_csv("vcluster_scaling_strong.csv", delimiter=";", header=None,
                            names=['proc', 'size', 'time', 'pi'])
    ...
    plt.plot(df_poor_mean['proc'], df_poor_mean['time'], ':', color="grey", label='time vs proc', markersize=8)

    plt.errorbar(df_poor_mean['proc'], df_poor_mean['time'], yerr=std_time_strong, fmt='o', capsize=5, markersize=8,
                 label='time vs proc', color="blue")
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(df_strong_mean['proc'], df_strong_mean['time'], ':', color="grey", label='time vs proc', markersize=8)
...
def vcluster_speedup_processes():
    ...
    plt.plot(df_poor_mean['proc'], df_poor_mean['speedup'], 'o', color="blue", markersize=8)
    ...
    plt.plot(df_strong_mean['proc'], df_strong_mean['speedup'], 'o:', color="blue", markersize=8)
...
def vcluster_efficiency_processes():
    ...
    plt.plot(df_poor_mean['proc'], df_poor_mean['efficiency'], 'o', color="blue", markersize=8)
    ...
    plt.plot(df_strong_mean['proc'], df_strong_mean['efficiency'], 'o:', color="blue", markersize=8)
...
def vcluster_serial_fraction_processes():
    ...
    plt.plot(df_poor_mean['proc'], df_poor_mean['serial_fraction'], 'o', color="blue", markersize=8)
    ...
    plt.plot(df_strong_mean['proc'], df_strong_mean['serial_fraction'], 'o:', color="blue", markersize=8)
    plt.plot(df_strong_mean['proc'], ideal_scaling_efficiency_strong, 'r-', label='ideal scaling')
    plt.xlabel('number of processes')
    plt.ylabel('serial fraction')
...
if __name__ == "__main__":
    update_result_csv("vcluster_scaling_poor.csv", "vcluster_mean_scaling_poor.csv")
    update_result_csv("vcluster_scaling_strong.csv", "vcluster_mean_scaling_strong.csv")
